const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HUDMaterial.glsl-BCQQ6iSP.js","assets/index-DoEPQZdp.js","assets/index-BiBeHUVx.css","assets/OutputColorHighlightOID.glsl-BXgCSdjF.js","assets/videoUtils-pOA7VA2b.js","assets/requestImageUtils-CCbY-7VO.js","assets/basicInterfaces-N86vRvDz.js","assets/TextureFormat-1mYWTFa-.js","assets/BufferView-4OfUiAVr.js","assets/mat4f64-q_b6UJoq.js","assets/Indices-Ce1Ik5n4.js","assets/triangle-Byk7CEOX.js","assets/sphere-C7hROdrv.js","assets/mat3f64-B5o_lm6j.js","assets/vectorStacks-Cam1HRV0.js","assets/quatf64-aQ5IuZRd.js","assets/lineSegment-CG4wUDUM.js","assets/VertexAttribute-BfkzOMLV.js","assets/glsl-Cj7KC756.js","assets/BindType-BBwFZqyN.js","assets/ShaderOutput-Bdd80V3g.js","assets/renderState-DC_TDyw7.js","assets/orientedBoundingBox-C44QwFGc.js","assets/quat-BHGBo43L.js","assets/spatialReferenceEllipsoidUtils-BX40oGo9.js","assets/computeTranslationToOriginAndRotation-DpXdigi1.js","assets/plane-0Astc4RJ.js","assets/boundedPlane-Dg-T8r5v.js","assets/projectVectorToVector-pYeppsL2.js","assets/projectPointToVector-C1IZQAWg.js","assets/dehydratedFeatureUtils-CabYj1IE.js","assets/meshVertexSpaceUtils-rCL81Jxz.js","assets/MeshLocalVertexSpace-DWWbHgz9.js","assets/hydratedFeatures-CzBhJaGA.js","assets/vec3f32-WCVSSNPR.js","assets/ShaderBuilder-DfHrDdAZ.js"])))=>i.map(i=>d[i]);
import{of as Se,ci as Re,aq as ut,h5 as Pe,og as dt,jW as Ae,oh as ft,kk as pt,hX as ht,_ as gt,jG as Fe,k0 as vt,r as A,mB as Ie,hT as ke,fg as le,da as G,fe as Y,dw as xe,eZ as Xe,f0 as q,kb as pe,oi as We,df as Qe,dG as X,fc as oe,fh as Ze,bU as mt,e$ as Ee,g4 as St,b0 as xt,hP as bt,ds as Ct,dc as Ot,oj as $t,dI as Tt}from"./index-DoEPQZdp.js";import{i as Pt,L as At,a as Et,m as yt,s as zt,b as Rt,e as Ft,c as It,o as wt,d as we,f as ge,g as _e,h as De,w as _t,t as Dt,j as Mt,k as H,l as jt,q as Lt,r as Nt,u as ee,v as Bt,x as Ut,F as Vt,y as qt,z as Ht,A as Gt,B as kt,C as E,D as Xt,E as Z,G as Wt,H as Ye,I as Je,J as Qt,K as Zt,M as Yt,N as Jt,O as Kt,R as eo,S as to,P as oo,Q as io,T as Me,U as je,V as ao,W as so,X as Le}from"./OutputColorHighlightOID.glsl-BXgCSdjF.js";import{e as Ke}from"./mat3f64-B5o_lm6j.js";import{e as ro}from"./mat4f64-q_b6UJoq.js";import{s as no,g as lo,o as Ne,f as co,y as uo,T as Be}from"./BufferView-4OfUiAVr.js";import{O as fo}from"./InterleavedLayout-zy6zo56g.js";import{n as B,u as et,w as ve}from"./ShaderOutput-Bdd80V3g.js";import{l as tt,u as po,n as ho,t as go,d as vo}from"./dehydratedFeatureUtils-CabYj1IE.js";import{e as u}from"./VertexAttribute-BfkzOMLV.js";import{n as d,t as z}from"./glsl-Cj7KC756.js";import{a as mo}from"./BindType-BBwFZqyN.js";import{i as So}from"./ShaderBuilder-DfHrDdAZ.js";import{B as xo,o as bo,g as Co,p as Oo}from"./renderState-DC_TDyw7.js";let $o=class extends Pt{constructor(e,t){super(e,"vec4",mo.Draw,((i,a,s)=>i.setUniform4fv(e,t(a,s))))}};const ye=128,Q=.5,fi=Se(Q/2,Q/2,1-Q/2,1-Q/2);function pi(o){return o==="cross"||o==="x"}function hi(o,e=ye,t=e*Q,i=0){const{data:a,parameters:s}=To(o,e,t,i);return new At(a,s)}function To(o,e=ye,t=e*Q,i=0){return{data:Po(o,e,t,i),parameters:{mipmap:!1,wrap:{s:Re.CLAMP_TO_EDGE,t:Re.CLAMP_TO_EDGE},width:e,height:e,components:4,noUnpackFlip:!0,reloadable:!0}}}function Po(o,e=ye,t=e*Q,i=0){switch(o){case"circle":default:return Ao(e,t);case"square":return Eo(e,t);case"cross":return zo(e,t,i);case"x":return Ro(e,t,i);case"kite":return yo(e,t);case"triangle":return Fo(e,t);case"arrow":return Io(e,t)}}function Ao(o,e){const t=o/2-.5;return ae(o,at(t,t,e/2))}function Eo(o,e){return ot(o,e,!1)}function yo(o,e){return ot(o,e,!0)}function zo(o,e,t=0){return it(o,e,!1,t)}function Ro(o,e,t=0){return it(o,e,!0,t)}function Fo(o,e){return ae(o,st(o/2,e,e/2))}function Io(o,e){const t=e,i=e/2,a=o/2,s=.8*t,r=at(a,(o-e)/2-s,Math.sqrt(s*s+i*i)),l=st(a,t,i);return ae(o,((c,n)=>Math.max(l(c,n),-r(c,n))))}function ot(o,e,t){return t&&(e/=Math.SQRT2),ae(o,((i,a)=>{let s=i-.5*o+.25,r=.5*o-a-.75;if(t){const l=(s+r)/Math.SQRT2;r=(r-s)/Math.SQRT2,s=l}return Math.max(Math.abs(s),Math.abs(r))-.5*e}))}function it(o,e,t,i=0){e-=i,t&&(e*=Math.SQRT2);const a=.5*e;return ae(o,((s,r)=>{let l,c=s-.5*o,n=.5*o-r-1;if(t){const S=(c+n)/Math.SQRT2;n=(n-c)/Math.SQRT2,c=S}return c=Math.abs(c),n=Math.abs(n),l=c>n?c>a?Math.sqrt((c-a)*(c-a)+n*n):n:n>a?Math.sqrt(c*c+(n-a)*(n-a)):c,l-=i/2,l}))}function at(o,e,t){return(i,a)=>{const s=i-o,r=a-e;return Math.sqrt(s*s+r*r)-t}}function st(o,e,t){const i=Math.sqrt(e*e+t*t);return(a,s)=>{const r=Math.abs(a-o)-t,l=s-o+e/2+.75,c=(e*r+t*l)/i,n=-l;return Math.max(c,n)}}function ae(o,e){const t=new Uint8Array(4*o*o);for(let i=0;i<o;i++)for(let a=0;a<o;a++){const s=a+o*i;let r=e(a,i);r=r/o+.5,ut(r,t,4*s)}return t}function wo(o){return o instanceof Float32Array&&o.length>=16}function _o(o){return Array.isArray(o)&&o.length>=16}function Do(o){return wo(o)||_o(o)}class Mo{constructor(){this.factor=new Ue,this.factorAlignment=new Ue}}class Ue{constructor(){this.scale=0,this.factor=0,this.minScaleFactor=0}}function jo(o,e){const{vertex:t,fragment:i}=o;o.include(Et,e),t.include(tt),t.main.add(d`vec4 posProjCenter;
